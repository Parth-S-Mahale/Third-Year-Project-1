                              ...
                              <div className="mt-2 space-y-2">
                                <div>
                                  ...
                                  <div className="flex flex-wrap gap-1.5 mt-1">
                                    {request.sender.gainedSkills.map(
                                      (skill) => (
                                        <div
                                          key={skill}
                                          className="badge badge-secondary gap-1.5 text-xs"
                                        >
                                          {capitialize(skill)}
                                        </div>
                                      )
                                ...
                                <div>
                                  ...
                                  <div className="flex flex-wrap gap-1.5 mt-1">
                                    {request.sender.learningSkills.map(
                                      (skill) => (
                                        <div
                                          key={skill}
                                          className="badge badge-primary badge-outline gap-1.5 text-xs"
                                        >
                                          {capitialize(skill)}
                                        </div>
                                      )
